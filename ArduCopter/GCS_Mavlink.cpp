...
/*
//hualiang
NOINLINE void Copter::send_data_transmission_handshake(mavlink_channel_t chan)
{
	//hardcoded
...
//hualiang
NOINLINE void Copter::send_encapsulated_data(mavlink_channel_t chan)
{
	//hard coded
	uint16_t seqnr;
	const uint8_t *data;
...
bool GCS_MAVLINK::try_send_message(enum ap_message id)
{
    ...
    case MSG_DATA_TRANSMISSION_HANDSHAKE:		//hualiang
    	CHECK_PAYLOAD_SIZE(DATA_TRANSMISSION_HANDSHAKE);
    	copter.gcs[chan-MAVLINK_COMM_0].send_data_transmission_handshake();
    	break;

    case MSG_ENCAPSULATED_DATA:		//hualiang
...
GCS_MAVLINK::data_stream_send(void)
{
    ...
    if (stream_trigger(STREAM_EXTRA3)) {
        ...
        send_message(MSG_DATA_TRANSMISSION_HANDSHAKE);	//hualiang
        send_message(MSG_ENCAPSULATED_DATA);		//hualiang
    }
}
